...
RESOLVER_NAME = 'sceptre-kms-resolver'
# the resolver call in sceptre e.g. !command_name.
RESOLVER_COMMAND_NAME = 'kms'
...
RESOLVER_CLASS = 'KmsResolver'
# One line summary description
RESOLVER_DESCRIPTION = 'A Sceptre resolver to retrieve and decrypt values from AWS KMS'
